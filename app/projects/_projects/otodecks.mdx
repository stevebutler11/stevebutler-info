...
<img
  className="w-full h-full object-cover rounded-lg shadow-md group-hover:opacity-90 transition-opacity"
  src={'/images/otodecks_screenshot.png'}
  alt={'OtoDecks DJ Software'}
  width={1000}
  height={1000}
/>
